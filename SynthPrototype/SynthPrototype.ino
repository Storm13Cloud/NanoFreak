...
void loop() {
  ...
  amy_update();
  resonancePotValue = 4095.0f - analogRead(resonancePot);
  cutoffPotValue = 4095.0f - analogRead(cutoffPot);
  ...
  for (int i = 0; i < samplesVolume; i++) {
    totalVolume += 4095.0f - analogRead(volumePot);
  }
